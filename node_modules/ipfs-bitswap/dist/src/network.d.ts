...
declare class Network {
     ...
     */
    constructor(libp2p: import('libp2p'), bitswap: import('./bitswap'), stats: import('./stats'), options?: {
...
declare namespace Network {
    export { PeerId, CID, Multiaddr, Connection, MuxedStream, MultihashHasher, Provider, Stream };
}
type CID = import('multiformats').CID;
type Provider = {
    id: PeerId;
