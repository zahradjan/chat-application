...
declare namespace BitswapMessage {
    export { deserialize, blockPresenceSize, Entry, WantType, BlockPresenceType, MultihashHasher };
}
 ...
 */
declare function deserialize(raw: Uint8Array, hashers?: Record<number, import("multiformats/hashes/interface").MultihashHasher> | undefined): Promise<BitswapMessage>;
/**
 * @param {CID} cid
 */
declare function blockPresenceSize(cid: CID): number;
declare namespace WantType {
    const Block: Message.Wantlist.WantType;
    const Have: Message.Wantlist.WantType;
}
declare namespace BlockPresenceType {
